...
#define TIMER1_SYNCHRONCE_COUNTER_MODE()                    CLEAR_BIT(T1CON, _T1CON_T1SYNC_POSITION)
#define TIMER1_ASYNCHRONCE_COUNTER_MODE()                   SET_BIT(T1CON, _T1CON_T1SYNC_POSITION)
