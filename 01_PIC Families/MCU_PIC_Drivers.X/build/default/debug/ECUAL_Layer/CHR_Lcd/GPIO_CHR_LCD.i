# 1 "ECUAL_Layer/CHR_Lcd/GPIO_CHR_LCD.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECUAL_Layer/CHR_Lcd/GPIO_CHR_LCD.c" 2
# 10 "ECUAL_Layer/CHR_Lcd/GPIO_CHR_LCD.c"
# 1 "ECUAL_Layer/CHR_Lcd/GPIO_CHR_LCD.h" 1
# 15 "ECUAL_Layer/CHR_Lcd/GPIO_CHR_LCD.h"
# 1 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h" 1
# 15 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 16 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 1 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/HAL_GPIO_CFG.h" 1
# 17 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 1 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../mcal_std_types.h" 1
# 15 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 15 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 16 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 17 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../std_libraries.h" 2
# 1 "/Applications/microchip/xc8/v3.00/pic/include/c99/stdbool.h" 1 3
# 18 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 19 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 20 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../std_libraries.h" 2
# 16 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 1 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../compiler.h" 1
# 15 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../compiler.h"
...
# 16 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../compiler.h" 2
# 17 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 121 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 149 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../mcal_std_types.h"
typedef enum{
    E_NOT_OK = (uint8)0x00,
    E_OK = (uint8)0x01
}Std_ReturnType;
# 18 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 1 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/../device_cfg.h" 1
# 19 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 34 "ECUAL_Layer/CHR_Lcd/../../MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 16 "ECUAL_Layer/CHR_Lcd/GPIO_CHR_LCD.h" 2
...
# 11 "ECUAL_Layer/CHR_Lcd/GPIO_CHR_LCD.c" 2
...
Std_ReturnType GPIO_LCD_4BIT_INIT(const CHR_LCD_4BIT *lcd){
    ...
    if(((void*)0) == lcd){
        ...
        for(uint8 i = (uint8)0x00; i < (uint8)0x04; i++){
        ...
        Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)0x01);
        Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)0x02);
        Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)0x06);
        Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)0x0C);
        Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)0x28);
        Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)0x80);
    }
    return Retval;
}
...
Std_ReturnType GPIO_LCD_4BIT_SEND_CUSTOM_CHARACTER(const CHR_LCD_4BIT *lcd, const uint8 c_character[], uint8 row, uint8 col, uint8 ram_pos){
    ...
    if(((void*)0) == lcd){
        ...
        Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, ((uint8)0x40 + (ram_pos * 8)));
...
Std_ReturnType GPIO_LCD_8BIT_INIT(const CHR_LCD_8BIT *lcd){
    ...
    if(((void*)0) == lcd){
        ...
        for(uint8 i = (uint8)0x00; i < (uint8)0x08; i++){
            Retval = GPIO_PIN_INIT(&(lcd->data_pins[i]));
        }
        ...
        Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)0x01);
        Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)0x02);
        Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)0x06);
        Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)0x0C);
        Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)0x38);
        Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)0x80);
    }
    return Retval;
}
...
Std_ReturnType GPIO_LCD_8BIT_SEND_COMMAND(const CHR_LCD_8BIT *lcd,uint8 command){
    ...
    if(((void*)0) == lcd){
        ...
        for(uint8 i = (uint8)0x00; i < (uint8)0x08; i++){
            Retval = GPIO_PIN_WRITE_LOGIC(&(lcd->data_pins[i]), (GPIO_LOGIC)((command >> i) & (uint8)(uint8)0x01));
        }
...
Std_ReturnType GPIO_LCD_8BIT_SEND_CHARACTER(const CHR_LCD_8BIT *lcd, uint8 character){
    ...
    if(((void*)0) == lcd){
        ...
        for(uint8 i = (uint8)0x00; i < (uint8)0x08; i++){
            Retval = GPIO_PIN_WRITE_LOGIC(&(lcd->data_pins[i]), (GPIO_LOGIC)((character >> i) & (uint8)(uint8)0x01));
        }
        Retval = chr_lcd_8bit_send_enable_signal(lcd);
    }
    return Retval;
...
Std_ReturnType GPIO_LCD_8BIT_SEND_CUSTOM_CHARACTER(const CHR_LCD_8BIT *lcd, const uint8 c_character[], uint8 row, uint8 col, uint8 ram_pos){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == lcd || ((void*)0) == c_character || ram_pos >= (uint8)0x08){
        Retval = E_NOT_OK;
    }
    else{
        Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, ((uint8)0x40 + (ram_pos * 8)));
        for(uint8 i = 0; i < (uint8)0x08; i++){
...
static Std_ReturnType chr_lcd_4bit_send_4bit(const CHR_LCD_4BIT *lcd, uint8 data){
    ...
    if(((void*)0) == lcd){
        ...
        for(uint8 i = (uint8)0x00; i < (uint8)0x04; i++){
            Retval = GPIO_PIN_WRITE_LOGIC(&(lcd->data_pins[i]), (GPIO_LOGIC)((data >> i) & (uint8)(uint8)0x01));
        }
    }
    return Retval;
}
...
static Std_ReturnType chr_lcd_4bit_set_cursor_pos(const CHR_LCD_4BIT *lcd, uint8 row, uint8 col){
    ...
    if(((void*)0) == lcd){
        ...
        switch(row){
            case (uint8)0x01:
                Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)((uint8)0x80 + col));
                break;
            case (uint8)0x02:
                Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)((uint8)0xC0 + col));
                break;
            case (uint8)0x03:
                Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)((uint8)0x94 + col));
                break;
            case (uint8)0x04:
                Retval = GPIO_LCD_4BIT_SEND_COMMAND(lcd, (uint8)((uint8)0xD4 + col));
                break;
            default :
                Retval = E_NOT_OK;
                break;
...
static Std_ReturnType chr_lcd_8bit_set_cursor_pos(const CHR_LCD_8BIT *lcd, uint8 row, uint8 col){
    ...
    if(((void*)0) == lcd){
        ...
        switch(row){
            case (uint8)0x01:
                Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)((uint8)0x80 + col));
                break;
            case (uint8)0x02:
                Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)((uint8)0xC0 + col));
                break;
            case (uint8)0x03:
                Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)((uint8)0x94 + col));
                break;
            case (uint8)0x04:
                Retval = GPIO_LCD_8BIT_SEND_COMMAND(lcd, (uint8)((uint8)0xD4 + col));
                break;
            default :
                Retval = E_NOT_OK;
                break;
