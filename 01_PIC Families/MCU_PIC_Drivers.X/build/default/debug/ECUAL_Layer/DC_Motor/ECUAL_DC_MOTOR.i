# 1 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c" 2
# 10 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c"
# 1 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.h" 1
# 15 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.h"
# 1 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/HAL_GPIO.h" 1
# 15 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 16 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 1 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/HAL_GPIO_CFG.h" 1
# 17 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 1 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../mcal_std_types.h" 1
# 15 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../mcal_std_types.h"
# 1 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../std_libraries.h" 1
# 15 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../std_libraries.h"
...
# 16 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 17 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../std_libraries.h" 2
# 1 "/Applications/microchip/xc8/v3.00/pic/include/c99/stdbool.h" 1 3
# 18 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 19 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 20 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../std_libraries.h" 2
# 16 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 1 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../compiler.h" 1
# 15 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../compiler.h"
...
# 16 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../compiler.h" 2
# 17 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 103 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 126 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../mcal_std_types.h"
typedef enum{
    E_NOT_OK = (uint8)0x00,
    E_OK = (uint8)0x01
}Std_ReturnType;
# 18 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 1 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/../device_cfg.h" 1
# 19 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 40 "ECUAL_Layer/DC_Motor/../../MCAL_Layer/GPIO/HAL_GPIO.h"
...
# 16 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.h" 2
...
# 11 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c" 2
# 32 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c"
Std_ReturnType GPIO_DC_MOTOR_INIT(const DC_MOTOR *motor){
    ...
    if(((void*)0) == motor){
        ...
        for(uint8 i = 0; i < (uint8)0x02; i++){
            Retval = GPIO_PIN_INIT(&(motor->INs[i]));
        }
    }
    return Retval;
}
# 58 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c"
Std_ReturnType GPIO_DC_MOTOR_READ_ROTATE_DIRECTION(const DC_MOTOR *motor, MOTOR_STATE *state){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == motor || ((void*)0) == state){
        Retval = E_NOT_OK;
    }
    else{
        GPIO_LOGIC logic[(uint8)0x02];
        for(uint8 i = 0; i < (uint8)0x02; i++){
...
# 94 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c"
Std_ReturnType GPIO_DC_MOTOR_BRAKE(const DC_MOTOR *motor){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == motor){
        Retval = E_NOT_OK;
        ...
        GPIO_LOGIC logic[(uint8)0x02] = {GPIO_LOW, GPIO_LOW};
        for(uint8 i = 0; i < (uint8)0x02; i++){
...
# 120 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c"
Std_ReturnType GPIO_DC_MOTOR_ROTATE_CLOCKWISE(const DC_MOTOR *motor){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == motor){
        Retval = E_NOT_OK;
        ...
        GPIO_LOGIC logic[(uint8)0x02] = {GPIO_HIGH, GPIO_LOW};
        for(uint8 i = 0; i < (uint8)0x02; i++){
            Retval = GPIO_PIN_WRITE_LOGIC(&(motor->INs[i]), logic[i]);
        }
    }
...
# 146 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c"
Std_ReturnType GPIO_DC_MOTOR_ROTATE_COUNTER_CLOCKWISE(const DC_MOTOR *motor){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == motor){
        Retval = E_NOT_OK;
        ...
        GPIO_LOGIC logic[(uint8)0x02] = {GPIO_LOW, GPIO_HIGH};
        for(uint8 i = 0; i < (uint8)0x02; i++){
            Retval = GPIO_PIN_WRITE_LOGIC(&(motor->INs[i]), logic[i]);
        }
    }
...
# 173 "ECUAL_Layer/DC_Motor/ECUAL_DC_MOTOR.c"
Std_ReturnType GPIO_DC_MOTOR_ROTATE_TOGGLE(const DC_MOTOR *motor){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == motor){
        Retval = E_NOT_OK;
