...
# 15 "MCAL_Layer/EUSART/HAL_EUSART.h"
...
# 1 "MCAL_Layer/EUSART/../GPIO/HAL_GPIO.h" 1
# 16 "MCAL_Layer/EUSART/../GPIO/HAL_GPIO.h"
# 1 "MCAL_Layer/EUSART/../GPIO/HAL_GPIO_CFG.h" 1
# 17 "MCAL_Layer/EUSART/../GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/EUSART/../GPIO/../mcal_std_types.h" 1
# 15 "MCAL_Layer/EUSART/../GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/EUSART/../GPIO/../std_libraries.h" 1
# 15 "MCAL_Layer/EUSART/../GPIO/../std_libraries.h"
...
# 16 "MCAL_Layer/EUSART/../GPIO/../std_libraries.h" 2
...
# 17 "MCAL_Layer/EUSART/../GPIO/../std_libraries.h" 2
# 1 "/Applications/microchip/xc8/v3.00/pic/include/c99/stdbool.h" 1 3
# 18 "MCAL_Layer/EUSART/../GPIO/../std_libraries.h" 2
...
# 19 "MCAL_Layer/EUSART/../GPIO/../std_libraries.h" 2
...
# 20 "MCAL_Layer/EUSART/../GPIO/../std_libraries.h" 2
# 16 "MCAL_Layer/EUSART/../GPIO/../mcal_std_types.h" 2
# 1 "MCAL_Layer/EUSART/../GPIO/../compiler.h" 1
# 15 "MCAL_Layer/EUSART/../GPIO/../compiler.h"
...
# 16 "MCAL_Layer/EUSART/../GPIO/../compiler.h" 2
# 17 "MCAL_Layer/EUSART/../GPIO/../mcal_std_types.h" 2
# 121 "MCAL_Layer/EUSART/../GPIO/../mcal_std_types.h"
...
# 149 "MCAL_Layer/EUSART/../GPIO/../mcal_std_types.h"
typedef enum{
    E_NOT_OK = (uint8)0x00,
    E_OK = (uint8)0x01
}Std_ReturnType;
# 18 "MCAL_Layer/EUSART/../GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/EUSART/../GPIO/../device_cfg.h" 1
# 19 "MCAL_Layer/EUSART/../GPIO/HAL_GPIO.h" 2
# 34 "MCAL_Layer/EUSART/../GPIO/HAL_GPIO.h"
...
# 18 "MCAL_Layer/EUSART/HAL_EUSART.h" 2
# 1 "MCAL_Layer/EUSART/../Interrupt/HAL_INT_INTERRUPT.h" 1
# 15 "MCAL_Layer/EUSART/../Interrupt/HAL_INT_INTERRUPT.h"
# 1 "MCAL_Layer/EUSART/../Interrupt/HAL_INTERRUPT_CFG.h" 1
# 16 "MCAL_Layer/EUSART/../Interrupt/HAL_INTERRUPT_CFG.h"
# 1 "MCAL_Layer/EUSART/../Interrupt/HAL_INTERRUPT_GEN_CFG.h" 1
# 17 "MCAL_Layer/EUSART/../Interrupt/HAL_INTERRUPT_CFG.h" 2
# 81 "MCAL_Layer/EUSART/../Interrupt/HAL_INTERRUPT_CFG.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = (uint8)0x00,
    INTERRUPT_HIGH_PRIORITY = (uint8)0x01
}INTERRUPT_PRIORITY;
# 16 "MCAL_Layer/EUSART/../Interrupt/HAL_INT_INTERRUPT.h" 2
# 19 "MCAL_Layer/EUSART/HAL_EUSART.h" 2
# 76 "MCAL_Layer/EUSART/HAL_EUSART.h"
...
# 11 "MCAL_Layer/EUSART/HAL_EUSART.c" 2
...
static EUSART_HANDLER EUSART_TX_HANDLER_FUNCTION = ((void*)0);
static EUSART_HANDLER EUSART_RX_HANDLER_FUNCTION = ((void*)0);
static EUSART_HANDLER EUSART_FRAMING_HANDLER_FUNCTION = ((void*)0);
static EUSART_HANDLER EUSART_OVERRUN_HANDLER_FUNCTION = ((void*)0);
...
Std_ReturnType EUSART_ASYNC_RX_READ_BYTE_NON_BLOCKING(const EUSART_CFG *eusart, uint8 *data){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == eusart || ((void*)0) == data){
        Retval = E_NOT_OK;
    }
    else{
        if(((PIR1 >> 0x5) & (uint8)(uint8)0x01)){
            *data = RCREG;
        }
        else{
...
Std_ReturnType EUSART_ASYNC_RX_READ_BYTE_BLOCKING(const EUSART_CFG *eusart, uint8 *data){
    ...
    if(((void*)0) == eusart || ((void*)0) == data){
        ...
        while(!((PIR1 >> 0x5) & (uint8)(uint8)0x01));
        *data = RCREG;
    }
    return Retval;
}
    ...
    if(((void*)0) == eusart){
        ...
        switch(eusart->br_cfg){
            case EUSART_BR_ASYNC_8BIT_LOW_SPEED:
                (TXSTA &= ~(uint8)((uint8)0x01 << 0x4));
                (BAUDCON &= ~(uint8)((uint8)0x01 << 0x3));
                (TXSTA &= ~(uint8)((uint8)0x01 << 0x2));

                Buad_Rate_Temp = ((float32)(8000000UL/((eusart->baud_rate) * 64)) - 1);
            ...
            case EUSART_BR_ASYNC_8BIT_HIGH_SPEED:
                ...
                Buad_Rate_Temp = ((float32)(8000000UL/((eusart->baud_rate) * 16)) - 1);
            ...
            case EUSART_BR_ASYNC_16BIT_HIGH_SPEED:
                ...
                Buad_Rate_Temp = ((float32)(8000000UL/((eusart->baud_rate) * 4)) - 1);
