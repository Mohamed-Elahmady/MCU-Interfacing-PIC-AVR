...
# 19 "MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 20 "MCAL_Layer/GPIO/../std_libraries.h" 2
...
# 16 "MCAL_Layer/GPIO/../compiler.h" 2
# 17 "MCAL_Layer/GPIO/../mcal_std_types.h" 2
# 103 "MCAL_Layer/GPIO/../mcal_std_types.h"
...
# 126 "MCAL_Layer/GPIO/../mcal_std_types.h"
typedef enum{
    E_NOT_OK = (uint8)0x00,
    E_OK = (uint8)0x01
}Std_ReturnType;
# 18 "MCAL_Layer/GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/GPIO/../device_cfg.h" 1
...
volatile uint8 *TRIS_REGs[(uint8)0x05] = {&TRISA, &TRISB, &TRISC, &TRISD, &TRISE};
volatile uint8 *PORT_REGs[(uint8)0x05] = {&PORTA, &PORTB, &PORTC, &PORTD, &PORTE};
volatile uint8 *LAT_REGs[(uint8)0x05] = {&LATA, &LATB, &LATC, &LATD, &LATE};
# 34 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PIN_DIRECTION_INIT(const GPIO_PIN_CFG *pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == pin || pin->PIN >= (uint8)0x08){
        Retval = E_NOT_OK;
    }
    else{
        switch(pin->DIRECTION){
            case GPIO_OUTPUT:
                (*TRIS_REGs[pin->PORT] &= ~(uint8)((uint8)0x01 << pin->PIN));
                break;
            case GPIO_INPUT:
               (*TRIS_REGs[pin->PORT] |= (uint8)((uint8)0x01 << pin->PIN));
                break;
...
# 66 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PIN_GET_DIRECTION_STATUS(const GPIO_PIN_CFG *pin, GPIO_DIRECTION *direction){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == pin || pin->PIN >= (uint8)0x08 || ((void*)0) == direction){
        Retval = E_NOT_OK;
    }
    else{
        *direction = ((*TRIS_REGs[pin->PORT] >> pin->PIN) & (uint8)(uint8)0x01);
    }
    return (Retval);
}
...
Std_ReturnType GPIO_PIN_WRITE_LOGIC(const GPIO_PIN_CFG *pin, GPIO_LOGIC logic){
    ...
    if(((void*)0) == pin || pin->PIN >= (uint8)0x08){
        ...
        switch (logic){
            case GPIO_LOW:
                (*LAT_REGs[pin->PORT] &= ~(uint8)((uint8)0x01 << pin->PIN));
                break;
            case GPIO_HIGH:
                (*LAT_REGs[pin->PORT] |= (uint8)((uint8)0x01 << pin->PIN));
                break;
...
Std_ReturnType GPIO_PIN_READ_LOGIC(const GPIO_PIN_CFG *pin, GPIO_LOGIC *logic){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == pin || pin->PIN >= (uint8)0x08 || ((void*)0) == logic){
        Retval = E_NOT_OK;
    }
    else{
        *logic = ((*PORT_REGs[pin->PORT] >> pin->PIN) & (uint8)(uint8)0x01);
    }
    return (Retval);
}
...
# 170 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PIN_INIT(const GPIO_PIN_CFG *pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == pin || pin->PIN >= (uint8)0x08){
        Retval = E_NOT_OK;
...
# 196 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PORT_DIRECTION_INIT(const GPIO_PORT port, uint8 direction){
    Std_ReturnType Retval = E_OK;
    if(port >= (uint8)0x05){
        Retval = E_NOT_OK;
...
Std_ReturnType GPIO_PORT_GET_DIRECTION_STATUS(const GPIO_PORT port, uint8 *direction){
    Std_ReturnType Retval = E_OK;
    if(port >= (uint8)0x05 || ((void*)0) == direction){
        Retval = E_NOT_OK;
    }
    else{
...
# 244 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PORT_WRITE_LOGIC(const GPIO_PORT port, uint8 logic){
    Std_ReturnType Retval = E_OK;
    if(port >= (uint8)0x05){
        Retval = E_NOT_OK;
...
# 268 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PORT_READ_LOGIC(const GPIO_PORT port, uint8 *logic){
    Std_ReturnType Retval = E_OK;
    if(port >= (uint8)0x05 || ((void*)0) == logic){
        Retval = E_NOT_OK;
    }
    else{
...
# 291 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PORT_TOGGLE_LOGIC(const GPIO_PORT port){
    Std_ReturnType Retval = E_OK;
    if(port >= (uint8)0x05){
        Retval = E_NOT_OK;
        ...
        *LAT_REGs[port] ^= (uint8)0xFF;
    }
    return (Retval);
}
# 316 "MCAL_Layer/GPIO/HAL_GPIO.c"
Std_ReturnType GPIO_PORT_INIT(const GPIO_PORT port, uint8 direction, uint8 logic){
    Std_ReturnType Retval = E_OK;
    if(port >= (uint8)0x05){
        Retval = E_NOT_OK;
