...
# 1 "MCAL_Layer/ADC/../Interrupt/HAL_INT_INTERRUPT.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/HAL_INT_INTERRUPT.h"
# 1 "MCAL_Layer/ADC/../Interrupt/HAL_INTERRUPT_CFG.h" 1
# 16 "MCAL_Layer/ADC/../Interrupt/HAL_INTERRUPT_CFG.h"
# 1 "MCAL_Layer/ADC/../Interrupt/HAL_INTERRUPT_GEN_CFG.h" 1
# 17 "MCAL_Layer/ADC/../Interrupt/HAL_INTERRUPT_CFG.h" 2
# 1 "MCAL_Layer/ADC/../Interrupt/../GPIO/HAL_GPIO.h" 1
# 16 "MCAL_Layer/ADC/../Interrupt/../GPIO/HAL_GPIO.h"
# 1 "MCAL_Layer/ADC/../Interrupt/../GPIO/HAL_GPIO_CFG.h" 1
# 17 "MCAL_Layer/ADC/../Interrupt/../GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/ADC/../Interrupt/../GPIO/../mcal_std_types.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/../GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/ADC/../Interrupt/../GPIO/../std_libraries.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/../GPIO/../std_libraries.h"
...
# 16 "MCAL_Layer/ADC/../Interrupt/../GPIO/../std_libraries.h" 2
...
# 17 "MCAL_Layer/ADC/../Interrupt/../GPIO/../std_libraries.h" 2
# 1 "/Applications/microchip/xc8/v3.00/pic/include/c99/stdbool.h" 1 3
# 18 "MCAL_Layer/ADC/../Interrupt/../GPIO/../std_libraries.h" 2
...
# 19 "MCAL_Layer/ADC/../Interrupt/../GPIO/../std_libraries.h" 2
...
# 20 "MCAL_Layer/ADC/../Interrupt/../GPIO/../std_libraries.h" 2
# 16 "MCAL_Layer/ADC/../Interrupt/../GPIO/../mcal_std_types.h" 2
# 1 "MCAL_Layer/ADC/../Interrupt/../GPIO/../compiler.h" 1
# 15 "MCAL_Layer/ADC/../Interrupt/../GPIO/../compiler.h"
...
# 16 "MCAL_Layer/ADC/../Interrupt/../GPIO/../compiler.h" 2
# 17 "MCAL_Layer/ADC/../Interrupt/../GPIO/../mcal_std_types.h" 2
# 121 "MCAL_Layer/ADC/../Interrupt/../GPIO/../mcal_std_types.h"
...
# 149 "MCAL_Layer/ADC/../Interrupt/../GPIO/../mcal_std_types.h"
typedef enum{
    E_NOT_OK = (uint8)0x00,
    E_OK = (uint8)0x01
}Std_ReturnType;
# 18 "MCAL_Layer/ADC/../Interrupt/../GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/ADC/../Interrupt/../GPIO/../device_cfg.h" 1
# 19 "MCAL_Layer/ADC/../Interrupt/../GPIO/HAL_GPIO.h" 2
# 34 "MCAL_Layer/ADC/../Interrupt/../GPIO/HAL_GPIO.h"
...
# 81 "MCAL_Layer/ADC/../Interrupt/HAL_INTERRUPT_CFG.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = (uint8)0x00,
    INTERRUPT_HIGH_PRIORITY = (uint8)0x01
}INTERRUPT_PRIORITY;
# 16 "MCAL_Layer/ADC/../Interrupt/HAL_INT_INTERRUPT.h" 2
# 18 "MCAL_Layer/ADC/HAL_ADC.h" 2
# 79 "MCAL_Layer/ADC/HAL_ADC.h"
...
# 12 "MCAL_Layer/ADC/HAL_ADC.c" 2
# 21 "MCAL_Layer/ADC/HAL_ADC.c"
static ADC_HANDLER ADC_HANDLER_FUNCTION = ((void*)0);
...
Std_ReturnType ADC_INIT(const ADC_CFG *adc) {
    ...
    if (((void*)0) == adc || adc->channel > ADC_CHANNEL_AN12) {
        Retval = E_NOT_OK;
    } else {
...
Std_ReturnType ADC_SELECT_CHANNEL(const ADC_CFG *adc, ADC_CHANNEL_SELECT channel) {
    Std_ReturnType Retval = E_OK;
    if (((void*)0) == adc || channel > ADC_CHANNEL_AN12) {
        Retval = E_NOT_OK;
    } else {
...
# 127 "MCAL_Layer/ADC/HAL_ADC.c"
Std_ReturnType ADC_START_CONVERSION(const ADC_CFG *adc) {
    Std_ReturnType Retval = E_OK;
    if (((void*)0) == adc) {
        Retval = E_NOT_OK;
    } else {
        (ADCON0 |= (uint8)((uint8)0x01 << 0x1));
    }
    return Retval;
}
...
Std_ReturnType ADC_IS_CONVERSION_DONE(const ADC_CFG *adc, ADC_CONVERSION_STATES *state) {
    Std_ReturnType Retval = E_OK;
    if (((void*)0) == adc || ((void*)0) == state) {
        Retval = E_NOT_OK;
    } else {
        *state = ((ADCON0 >> 0x1) & (uint8)(uint8)0x01);
        if (*state == 0x00) {
...
Std_ReturnType ADC_GET_CONVERSION_BLOCKING(const ADC_CFG *adc, ADC_CHANNEL_SELECT channel, uint16 *result) {
    Std_ReturnType Retval = E_OK;
    if (((void*)0) == adc || ((void*)0) == result || channel > ADC_CHANNEL_AN12) {
        Retval = E_NOT_OK;
    } else {
        ...
        while (((ADCON0 >> 0x1) & (uint8)(uint8)0x01));
        Retval = ADC_GET_CONVERSION_RESULT(adc, result);
    }
    return Retval;
}
# 225 "MCAL_Layer/ADC/HAL_ADC.c"
Std_ReturnType ADC_START_CONVERSION_INTERRUPT(const ADC_CFG *adc, ADC_CHANNEL_SELECT channel) {
    Std_ReturnType Retval = E_OK;
    if (((void*)0) == adc || channel > ADC_CHANNEL_AN12) {
        Retval = E_NOT_OK;
...
# 271 "MCAL_Layer/ADC/HAL_ADC.c"
static Std_ReturnType ADC_SET_DISABLE(const ADC_CFG *adc) {
    Std_ReturnType Retval = E_OK;
    if (((void*)0) == adc) {
        Retval = E_NOT_OK;
    } else {
        (ADCON0 &= ~(uint8)((uint8)0x01 << 0x0));
    }
    return Retval;
}
# 290 "MCAL_Layer/ADC/HAL_ADC.c"
static Std_ReturnType ADC_SET_ENABLE(const ADC_CFG *adc) {
    Std_ReturnType Retval = E_OK;
    if (((void*)0) == adc) {
        Retval = E_NOT_OK;
    ...
    if (channel > ADC_CHANNEL_AN12) {
        ...
        switch (channel) {
            case ADC_CHANNEL_AN0:
            {
                ...
                (ANSEL |= (uint8)((uint8)0x01 << (uint8)0x00));
                break;
            }
            case ADC_CHANNEL_AN1:
            {
                ...
                (ANSEL |= (uint8)((uint8)0x01 << (uint8)0x01));
                break;
            }
            ...
            case ADC_CHANNEL_AN2:
            {
                ...
                (ANSEL |= (uint8)((uint8)0x01 << (uint8)0x02));
                break;
            }
            case ADC_CHANNEL_AN3:
            {
                ...
                (ANSEL |= (uint8)((uint8)0x01 << (uint8)0x03));
                break;
            }
            ...
            case ADC_CHANNEL_AN4:
            {
                ...
                (ANSEL |= (uint8)((uint8)0x01 << (uint8)0x04));
                break;
            }
            case ADC_CHANNEL_AN5:
            {
                ...
                (ANSEL |= (uint8)((uint8)0x01 << (uint8)0x05));
                break;
            }
            case ADC_CHANNEL_AN6:
            {
                ...
                (ANSEL |= (uint8)((uint8)0x01 << (uint8)0x06));
                break;
            }
            case ADC_CHANNEL_AN7:
            {
                ...
                (ANSEL |= (uint8)((uint8)0x01 << (uint8)0x07));
                break;
            }
            case ADC_CHANNEL_AN8:
            {
                ...
                (ANSELH |= (uint8)((uint8)0x01 << (uint8)0x00));
                break;
            }
            case ADC_CHANNEL_AN9:
            {
                ...
                (ANSELH |= (uint8)((uint8)0x01 << (uint8)0x01));
                break;
            }
            case ADC_CHANNEL_AN10:
            {
                ...
                (ANSELH |= (uint8)((uint8)0x01 << (uint8)0x02));
                break;
            }
            case ADC_CHANNEL_AN11:
            {
                ...
                (ANSELH |= (uint8)((uint8)0x01 << (uint8)0x03));
                break;
            }
            case ADC_CHANNEL_AN12:
            {
                ...
                (ANSELH |= (uint8)((uint8)0x01 << (uint8)0x04));
                break;
            }
            default:
            {
    ...
    if (((void*)0) == adc) {
        ...
        switch (adc->vref) {
            case ADC_INTERNAL_VOLTAGE_REFERENCE:
                (ADCON1 &= ~(uint8)((uint8)0x01 << 0x4));
                (ADCON1 &= ~(uint8)((uint8)0x01 << 0x5));
                break;
