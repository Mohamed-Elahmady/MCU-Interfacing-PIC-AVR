...
# 10 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
# 1 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.h" 1
# 15 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.h"
...
# 16 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.h" 2
# 1 "MCAL_Layer/Timers/Timer0/HAL_TIMER0_CFG.h" 1
# 17 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.h" 2
# 1 "MCAL_Layer/Timers/Timer0/../../GPIO/HAL_GPIO.h" 1
# 16 "MCAL_Layer/Timers/Timer0/../../GPIO/HAL_GPIO.h"
# 1 "MCAL_Layer/Timers/Timer0/../../GPIO/HAL_GPIO_CFG.h" 1
# 17 "MCAL_Layer/Timers/Timer0/../../GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/Timers/Timer0/../../GPIO/../mcal_std_types.h" 1
# 15 "MCAL_Layer/Timers/Timer0/../../GPIO/../mcal_std_types.h"
# 1 "MCAL_Layer/Timers/Timer0/../../GPIO/../std_libraries.h" 1
# 15 "MCAL_Layer/Timers/Timer0/../../GPIO/../std_libraries.h"
...
# 16 "MCAL_Layer/Timers/Timer0/../../GPIO/../std_libraries.h" 2
...
# 17 "MCAL_Layer/Timers/Timer0/../../GPIO/../std_libraries.h" 2
# 1 "/Applications/microchip/xc8/v3.00/pic/include/c99/stdbool.h" 1 3
# 18 "MCAL_Layer/Timers/Timer0/../../GPIO/../std_libraries.h" 2
...
# 19 "MCAL_Layer/Timers/Timer0/../../GPIO/../std_libraries.h" 2
...
# 20 "MCAL_Layer/Timers/Timer0/../../GPIO/../std_libraries.h" 2
# 16 "MCAL_Layer/Timers/Timer0/../../GPIO/../mcal_std_types.h" 2
# 1 "MCAL_Layer/Timers/Timer0/../../GPIO/../compiler.h" 1
# 15 "MCAL_Layer/Timers/Timer0/../../GPIO/../compiler.h"
...
# 16 "MCAL_Layer/Timers/Timer0/../../GPIO/../compiler.h" 2
# 17 "MCAL_Layer/Timers/Timer0/../../GPIO/../mcal_std_types.h" 2
# 121 "MCAL_Layer/Timers/Timer0/../../GPIO/../mcal_std_types.h"
...
# 149 "MCAL_Layer/Timers/Timer0/../../GPIO/../mcal_std_types.h"
typedef enum{
    E_NOT_OK = (uint8)0x00,
    E_OK = (uint8)0x01
}Std_ReturnType;
# 18 "MCAL_Layer/Timers/Timer0/../../GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/Timers/Timer0/../../GPIO/../device_cfg.h" 1
# 19 "MCAL_Layer/Timers/Timer0/../../GPIO/HAL_GPIO.h" 2
# 34 "MCAL_Layer/Timers/Timer0/../../GPIO/HAL_GPIO.h"
...
# 18 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.h" 2
# 1 "MCAL_Layer/Timers/Timer0/../../Interrupt/HAL_INT_INTERRUPT.h" 1
# 15 "MCAL_Layer/Timers/Timer0/../../Interrupt/HAL_INT_INTERRUPT.h"
# 1 "MCAL_Layer/Timers/Timer0/../../Interrupt/HAL_INTERRUPT_CFG.h" 1
# 16 "MCAL_Layer/Timers/Timer0/../../Interrupt/HAL_INTERRUPT_CFG.h"
# 1 "MCAL_Layer/Timers/Timer0/../../Interrupt/HAL_INTERRUPT_GEN_CFG.h" 1
# 17 "MCAL_Layer/Timers/Timer0/../../Interrupt/HAL_INTERRUPT_CFG.h" 2
# 81 "MCAL_Layer/Timers/Timer0/../../Interrupt/HAL_INTERRUPT_CFG.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = (uint8)0x00,
    INTERRUPT_HIGH_PRIORITY = (uint8)0x01
}INTERRUPT_PRIORITY;
# 16 "MCAL_Layer/Timers/Timer0/../../Interrupt/HAL_INT_INTERRUPT.h" 2
# 19 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.h" 2
# 45 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.h"
...
# 11 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c" 2
...
static TIMER0_HANDLER TIMER0_HANDLER_FUNCTION = ((void*)0);
...
# 83 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
Std_ReturnType TIMER0_DEINIT(const TIMER0_CFG *timer0){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
...
# 110 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
Std_ReturnType TIMER0_WRITE_DATA(const TIMER0_CFG *timer0, uint16 data){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
...
# 131 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
Std_ReturnType TIMER0_READ_DATA(const TIMER0_CFG *timer0, uint16 *data){
    Std_ReturnType Retval = E_OK;
...
# 155 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
void TMR0_ISR(void){
...
# 179 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
static Std_ReturnType TIMER0_SET_DISABLE(const TIMER0_CFG *timer0){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
        ...
        (T0CON &= ~(uint8)((uint8)0x01 << 0x7));
    }
    return Retval;
}
# 198 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
static Std_ReturnType TIMER0_SET_RESOLUTION(const TIMER0_CFG *timer0){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
...
# 227 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
static Std_ReturnType TIMER0_SET_MODE(const TIMER0_CFG *timer0){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
...
# 260 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
static Std_ReturnType TIMER0_SET_COUNTER_EDGE(const TIMER0_CFG *timer0){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
...
# 297 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
static Std_ReturnType TIMER0_SET_PRESCALAR(const TIMER0_CFG *timer0){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
...
# 327 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
static Std_ReturnType TIMER0_CONFIGURE_INTERRUPT(const TIMER0_CFG *timer0){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
...
# 371 "MCAL_Layer/Timers/Timer0/HAL_TIMER0.c"
static Std_ReturnType TIMER0_SET_ENABLE(const TIMER0_CFG *timer0){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == timer0){
        Retval= E_NOT_OK;
