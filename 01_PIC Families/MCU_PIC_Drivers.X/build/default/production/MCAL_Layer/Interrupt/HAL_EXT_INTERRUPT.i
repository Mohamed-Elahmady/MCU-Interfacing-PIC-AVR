# 1 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c" 2
# 10 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
# 1 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.h" 1
# 15 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.h"
...
# 16 "MCAL_Layer/Interrupt/HAL_INTERRUPT_CFG.h" 2
...
# 19 "MCAL_Layer/Interrupt/../GPIO/../std_libraries.h" 2
...
# 20 "MCAL_Layer/Interrupt/../GPIO/../std_libraries.h" 2
...
# 16 "MCAL_Layer/Interrupt/../GPIO/../compiler.h" 2
# 17 "MCAL_Layer/Interrupt/../GPIO/../mcal_std_types.h" 2
# 121 "MCAL_Layer/Interrupt/../GPIO/../mcal_std_types.h"
...
# 149 "MCAL_Layer/Interrupt/../GPIO/../mcal_std_types.h"
typedef enum{
    E_NOT_OK = (uint8)0x00,
    E_OK = (uint8)0x01
}Std_ReturnType;
# 18 "MCAL_Layer/Interrupt/../GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/Interrupt/../GPIO/../device_cfg.h" 1
...
# 81 "MCAL_Layer/Interrupt/HAL_INTERRUPT_CFG.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = (uint8)0x00,
    INTERRUPT_HIGH_PRIORITY = (uint8)0x01
}INTERRUPT_PRIORITY;
# 16 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.h" 2
# 104 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.h"
...
# 11 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c" 2
# 20 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
...
static INTERRUPT_HANDLER RB4_INTERRUPT_HANDLER_CHANGE_HIGH = ((void*)0);
static INTERRUPT_HANDLER RB5_INTERRUPT_HANDLER_CHANGE_HIGH = ((void*)0);
static INTERRUPT_HANDLER RB6_INTERRUPT_HANDLER_CHANGE_HIGH = ((void*)0);
static INTERRUPT_HANDLER RB7_INTERRUPT_HANDLER_CHANGE_HIGH = ((void*)0);

static INTERRUPT_HANDLER RB4_INTERRUPT_HANDLER_CHANGE_LOW = ((void*)0);
static INTERRUPT_HANDLER RB5_INTERRUPT_HANDLER_CHANGE_LOW = ((void*)0);
static INTERRUPT_HANDLER RB6_INTERRUPT_HANDLER_CHANGE_LOW = ((void*)0);
static INTERRUPT_HANDLER RB7_INTERRUPT_HANDLER_CHANGE_LOW = ((void*)0);
...
# 74 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
Std_ReturnType EXTERNAL_INTERRUPT_INTX_INIT(const INTERRUPT_INTX *int_pin){
...
# 108 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
Std_ReturnType EXTERNAL_INTERRUPT_INTX_DEINIT(const INTERRUPT_INTX *int_pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == int_pin){
        Retval = E_NOT_OK;
...
# 182 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
Std_ReturnType EXTERNAL_INTERRUPT_RBX_INIT(const INTERRUPT_RBX *int_pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == int_pin){
        Retval = E_NOT_OK;
...
# 214 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
Std_ReturnType EXTERNAL_INTERRUPT_RBX_DEINIT(const INTERRUPT_RBX *int_pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == int_pin){
        Retval = E_NOT_OK;
...
# 333 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
static Std_ReturnType INTERRUPT_INTX_PIN_INIT(const INTERRUPT_INTX *int_pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == int_pin){
        Retval = E_NOT_OK;
...
# 519 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
static Std_ReturnType INTERRUPT_INTX_EDGE_INIT(const INTERRUPT_INTX *int_pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == int_pin){
        Retval = E_NOT_OK;
...
# 656 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
static Std_ReturnType INTERRUPT_RBX_PIN_INIT(const INTERRUPT_RBX *int_pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == int_pin){
        Retval = E_NOT_OK;
...
static Std_ReturnType INTERRUPT_RBX_DISABLE(const INTERRUPT_RBX *int_pin) {
    ...
    if (((void*)0) == int_pin) {
        ...
        if ((IOCBbits.IOCB4 == 0x00) && (IOCBbits.IOCB5 == 0x00)
           && (IOCBbits.IOCB6 == 0x00) && (IOCBbits.IOCB7 == 0x00)) {
...
# 833 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
static Std_ReturnType RBX_SET_HANDLER(const INTERRUPT_RBX *int_pin){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == int_pin){
        Retval = E_NOT_OK;
...
# 867 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
static Std_ReturnType RB4_SET_HANDLER(INTERRUPT_HANDLER INTERRUPT_HANDLER_HIGH, INTERRUPT_HANDLER INTERRUPT_HANDLER_LOW){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == INTERRUPT_HANDLER_HIGH || ((void*)0) == INTERRUPT_HANDLER_LOW){
        Retval = E_NOT_OK;
    }
    else{
...
# 886 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
static Std_ReturnType RB5_SET_HANDLER(INTERRUPT_HANDLER INTERRUPT_HANDLER_HIGH, INTERRUPT_HANDLER INTERRUPT_HANDLER_LOW){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == INTERRUPT_HANDLER_HIGH || ((void*)0) == INTERRUPT_HANDLER_LOW){
        Retval = E_NOT_OK;
...
# 905 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
static Std_ReturnType RB6_SET_HANDLER(INTERRUPT_HANDLER INTERRUPT_HANDLER_HIGH, INTERRUPT_HANDLER INTERRUPT_HANDLER_LOW){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == INTERRUPT_HANDLER_HIGH || ((void*)0) == INTERRUPT_HANDLER_LOW){
        Retval = E_NOT_OK;
...
# 924 "MCAL_Layer/Interrupt/HAL_EXT_INTERRUPT.c"
static Std_ReturnType RB7_SET_HANDLER(INTERRUPT_HANDLER INTERRUPT_HANDLER_HIGH, INTERRUPT_HANDLER INTERRUPT_HANDLER_LOW){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == INTERRUPT_HANDLER_HIGH || ((void*)0) == INTERRUPT_HANDLER_LOW){
        Retval = E_NOT_OK;
