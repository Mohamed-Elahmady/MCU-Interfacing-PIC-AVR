...
# 16 "MCAL_Layer/I2C/../GPIO/../std_libraries.h" 2
...
# 17 "MCAL_Layer/I2C/../GPIO/../std_libraries.h" 2
# 1 "/Applications/microchip/xc8/v3.00/pic/include/c99/stdbool.h" 1 3
# 18 "MCAL_Layer/I2C/../GPIO/../std_libraries.h" 2
...
# 19 "MCAL_Layer/I2C/../GPIO/../std_libraries.h" 2
...
# 20 "MCAL_Layer/I2C/../GPIO/../std_libraries.h" 2
# 16 "MCAL_Layer/I2C/../GPIO/../mcal_std_types.h" 2
# 1 "MCAL_Layer/I2C/../GPIO/../compiler.h" 1
# 15 "MCAL_Layer/I2C/../GPIO/../compiler.h"
...
# 16 "MCAL_Layer/I2C/../GPIO/../compiler.h" 2
# 17 "MCAL_Layer/I2C/../GPIO/../mcal_std_types.h" 2
# 121 "MCAL_Layer/I2C/../GPIO/../mcal_std_types.h"
...
# 149 "MCAL_Layer/I2C/../GPIO/../mcal_std_types.h"
typedef enum{
    E_NOT_OK = (uint8)0x00,
    E_OK = (uint8)0x01
}Std_ReturnType;
# 18 "MCAL_Layer/I2C/../GPIO/HAL_GPIO.h" 2
# 1 "MCAL_Layer/I2C/../GPIO/../device_cfg.h" 1
# 19 "MCAL_Layer/I2C/../GPIO/HAL_GPIO.h" 2
# 34 "MCAL_Layer/I2C/../GPIO/HAL_GPIO.h"
...
# 1 "MCAL_Layer/I2C/../Interrupt/HAL_INT_INTERRUPT.h" 1
# 15 "MCAL_Layer/I2C/../Interrupt/HAL_INT_INTERRUPT.h"
# 1 "MCAL_Layer/I2C/../Interrupt/HAL_INTERRUPT_CFG.h" 1
# 16 "MCAL_Layer/I2C/../Interrupt/HAL_INTERRUPT_CFG.h"
# 1 "MCAL_Layer/I2C/../Interrupt/HAL_INTERRUPT_GEN_CFG.h" 1
# 17 "MCAL_Layer/I2C/../Interrupt/HAL_INTERRUPT_CFG.h" 2
# 81 "MCAL_Layer/I2C/../Interrupt/HAL_INTERRUPT_CFG.h"
typedef enum {
    INTERRUPT_LOW_PRIORITY = (uint8)0x00,
    INTERRUPT_HIGH_PRIORITY = (uint8)0x01
}INTERRUPT_PRIORITY;
# 16 "MCAL_Layer/I2C/../Interrupt/HAL_INT_INTERRUPT.h" 2
# 19 "MCAL_Layer/I2C/HAL_I2C.h" 2
# 98 "MCAL_Layer/I2C/HAL_I2C.h"
...
# 11 "MCAL_Layer/I2C/HAL_I2C.c" 2




static I2C_HANDLER I2C_HANDLER_FUNCTION = ((void*)0);
static I2C_HANDLER I2C_OVF_HANDLER_FUNCTION = ((void*)0);
static I2C_HANDLER I2C_COL_HANDLER_FUNCTION = ((void*)0);
...
Std_ReturnType I2C_DEINIT(const I2C_CFG *i2c){
    ...
    if(((void*)0) == i2c){
        ...
        (PIE2 &= ~(uint8)((uint8)0x01 << 0x3));
        (PIR1 &= ~(uint8)((uint8)0x01 << 0x3));
        (PIR2 &= ~(uint8)((uint8)0x01 << 0x3));
...
Std_ReturnType I2C_MASTER_SEND_START_CONDITION(const I2C_CFG *i2c){
    ...
    else
    {
        ...
        (SSPCON2 |= (uint8)((uint8)0x01 << 0x0));


        while (((SSPCON2 >> 0x0) & (uint8)(uint8)0x01));
        ...
        if (((SSPSTAT >> 0x3) & (uint8)(uint8)0x01)){
            Retval = E_OK;
        }
        else{
            Retval = E_NOT_OK;
...
Std_ReturnType I2C_MASTER_SEND_STOP_CONDITION(const I2C_CFG *i2c){
    ...
    if(((void*)0) == i2c){
        ...
        (SSPCON2 |= (uint8)((uint8)0x01 << 0x2));

        while(((SSPCON2 >> 0x2) & (uint8)(uint8)0x01));


        (PIR1 &= ~(uint8)((uint8)0x01 << 0x3));


        if(((SSPSTAT >> 0x4) & (uint8)(uint8)0x01)){
            Retval = E_OK;
        }
        else{
            Retval = E_NOT_OK;
...
Std_ReturnType I2C_MASTER_SEND_REPEATED_START_CONDITION(const I2C_CFG *i2c){
    ...
    if(((void*)0) == i2c){
        ...
        (SSPCON2 |= (uint8)((uint8)0x01 << 0x1));


        while (((SSPCON2 >> 0x1) & (uint8)(uint8)0x01));
...
Std_ReturnType I2C_MASTER_WRITE_BYTE_BLOCKING(const I2C_CFG *i2c, uint8 data, uint8 *ack){
    ...
    if(((void*)0) == i2c || ((void*)0) == ack){
        ...
        if(!((SSPCON2 >> 0x6) & (uint8)(uint8)0x01)){
            *ack = (uint8)0x00;
        }
        else{
            *ack = (uint8)0x01;
...
Std_ReturnType I2C_MASTER_WRITE_STRING_BLOCKING(const I2C_CFG *i2c, uint8 *str, uint8 *ack){
    Std_ReturnType Retval = E_OK;
    if(((void*)0) == i2c || ((void*)0) == str || ((void*)0) == ack){
        Retval = E_NOT_OK;
    }
    else{
        while(*str){
...
Std_ReturnType I2C_MASTER_READ_BYTE_BLOCKING(const I2C_CFG *i2c, uint8 *data, uint8 ack){
    ...
    if(((void*)0) == i2c || ((void*)0) == data){
        ...
        *data = SSPBUF;
        ...
        if(ack == (uint8)0x00){
            (SSPCON2 &= ~(uint8)((uint8)0x01 << 0x5));
        }
        else if(ack == (uint8)0x01){
            (SSPCON2 |= (uint8)((uint8)0x01 << 0x5));
        }
        else{
            Retval = E_NOT_OK;
        ...
        switch(i2c->i2c_frame.mode){
            case I2C_MASTER_MODE:
                ...
                if(i2c->i2c_frame.mode_cfg == I2C_MASTER_MODE_CLK || i2c->i2c_frame.mode_cfg == I2C_MASTER_MODE_FIRMWARE){
                    (SSPCON1bits.SSPM = (i2c->i2c_frame.mode_cfg & 0x0F));
                }
                else{
                    Retval = E_NOT_OK;
                }
                ...
                if(i2c->i2c_frame.mode_cfg == I2C_MASTER_MODE_CLK){
                    SSPADD = (uint8)(((8000000UL) / (i2c->i2c_clock * 4.0)) - 1);
                }
