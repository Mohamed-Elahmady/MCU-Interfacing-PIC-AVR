...
# 1 "MCAL/GPIO/../mcu_cfg.h" 1
# 15 "MCAL/GPIO/../mcu_cfg.h"
...
# 19 "MCAL/GPIO/../std_libraries.h" 2
...
# 20 "MCAL/GPIO/../std_libraries.h" 2
...
# 17 "MCAL/GPIO/../mcu_cfg.h" 2
# 1 "MCAL/GPIO/../device_cfg.h" 1
# 18 "MCAL/GPIO/../mcu_cfg.h" 2
...
# 11 "MCAL/GPIO/hal_gpio.c" 2



volatile uint8 * const tris_regs[(uint8)0x05] = {&TRISA, &TRISB, &TRISC, &TRISD, &TRISE};
volatile uint8 * const port_regs[(uint8)0x05] = {&PORTA, &PORTB, &PORTC, &PORTD, &PORTE};
volatile uint8 * const lat_regs[(uint8)0x05] = {&LATA, &LATB, &LATC, &LATD, &LATE};
# 28 "MCAL/GPIO/hal_gpio.c"
Std_ReturnType gpio_pin_direction_init(const gpio_pin_cfg *pin){
