# 1 "MCAL/INTERRUPT/hal_interrupt_mng.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL/INTERRUPT/hal_interrupt_mng.c" 2
# 10 "MCAL/INTERRUPT/hal_interrupt_mng.c"
# 1 "MCAL/INTERRUPT/hal_interrupt_mng.h" 1
# 15 "MCAL/INTERRUPT/hal_interrupt_mng.h"
# 1 "MCAL/INTERRUPT/hal_interrupt_cfg.h" 1
# 15 "MCAL/INTERRUPT/hal_interrupt_cfg.h"
# 1 "MCAL/INTERRUPT/../mcu_cfg.h" 1
# 15 "MCAL/INTERRUPT/../mcu_cfg.h"
...
# 16 "MCAL/INTERRUPT/../mcu_cfg.h" 2
# 1 "MCAL/INTERRUPT/../mcal_std_types.h" 1
# 15 "MCAL/INTERRUPT/../mcal_std_types.h"
# 1 "MCAL/INTERRUPT/../std_libraries.h" 1
# 15 "MCAL/INTERRUPT/../std_libraries.h"
...
# 16 "MCAL/INTERRUPT/../std_libraries.h" 2
...
# 17 "MCAL/INTERRUPT/../std_libraries.h" 2
# 1 "/Applications/microchip/xc8/v3.00/pic/include/c99/stdbool.h" 1 3
# 18 "MCAL/INTERRUPT/../std_libraries.h" 2
...
# 19 "MCAL/INTERRUPT/../std_libraries.h" 2
...
# 20 "MCAL/INTERRUPT/../std_libraries.h" 2
# 16 "MCAL/INTERRUPT/../mcal_std_types.h" 2
# 1 "MCAL/INTERRUPT/../compiler.h" 1
# 15 "MCAL/INTERRUPT/../compiler.h"
...
# 17 "MCAL/INTERRUPT/../mcu_cfg.h" 2
# 1 "MCAL/INTERRUPT/../device_cfg.h" 1
# 18 "MCAL/INTERRUPT/../mcu_cfg.h" 2
# 16 "MCAL/INTERRUPT/hal_interrupt_cfg.h" 2
...
# 118 "MCAL/INTERRUPT/hal_interrupt_mng.c"
void __attribute__((picinterrupt(("")))) interrupt_manager(void) {
    ...
    if((INTCONbits.RBIF == (uint8)0x01) && (INTCONbits.RBIE == (uint8)0x01)
            && (IOCBbits.IOCB4 == (uint8)0x01) && (PORTBbits.RB4 == gpio_high) && (rb4_flag == 0x01)){
        rb4_flag = 0x00;
        rb4_isr((uint8)0x01);
    }
    else { }
    ...
    if((INTCONbits.RBIF == (uint8)0x01) && (INTCONbits.RBIE == (uint8)0x01)
            && (IOCBbits.IOCB4 == (uint8)0x01) && (PORTBbits.RB4 == gpio_low) && (rb4_flag == 0x00)){
        rb4_flag = 0x01;
        rb4_isr((uint8)0x00);
    }
    else { }
    ...
    if((INTCONbits.RBIF == (uint8)0x01) && (INTCONbits.RBIE == (uint8)0x01)
            && (IOCBbits.IOCB5 == (uint8)0x01) && (PORTBbits.RB5 == gpio_high) && (rb5_flag == 0x01)){
        rb5_flag = 0x00;
        rb5_isr((uint8)0x01);
    }
    else { }
    ...
    if((INTCONbits.RBIF == (uint8)0x01) && (INTCONbits.RBIE == (uint8)0x01)
            && (IOCBbits.IOCB5 == (uint8)0x01) && (PORTBbits.RB5 == gpio_low) && (rb5_flag == 0x00)){
        rb5_flag = 0x01;
        rb5_isr((uint8)0x00);
    }
    else { }
    ...
    if((INTCONbits.RBIF == (uint8)0x01) && (INTCONbits.RBIE == (uint8)0x01)
            && (IOCBbits.IOCB6 == (uint8)0x01) && (PORTBbits.RB6 == gpio_high) && (rb6_flag == 0x01)){
        rb6_flag = 0x00;
        rb6_isr((uint8)0x01);
    }
    else { }
    ...
    if((INTCONbits.RBIF == (uint8)0x01) && (INTCONbits.RBIE == (uint8)0x01)
            && (IOCBbits.IOCB6 == (uint8)0x01) && (PORTBbits.RB6 == gpio_low) && (rb6_flag == 0x00)){
        rb6_flag = 0x01;
        rb6_isr((uint8)0x00);
    }
    else { }
    ...
    if((INTCONbits.RBIF == (uint8)0x01) && (INTCONbits.RBIE == (uint8)0x01)
            && (IOCBbits.IOCB7 == (uint8)0x01) && (PORTBbits.RB7 == gpio_high) && (rb7_flag == 0x01)){
        rb7_flag = 0x00;
        rb7_isr((uint8)0x01);
    }
    else { }
    ...
    if((INTCONbits.RBIF == (uint8)0x01) && (INTCONbits.RBIE == (uint8)0x01)
            && (IOCBbits.IOCB7 == (uint8)0x01) && (PORTBbits.RB7 == gpio_low) && (rb7_flag == 0x00)){
        rb7_flag = 0x01;
        rb7_isr((uint8)0x00);
    }
    else { }
