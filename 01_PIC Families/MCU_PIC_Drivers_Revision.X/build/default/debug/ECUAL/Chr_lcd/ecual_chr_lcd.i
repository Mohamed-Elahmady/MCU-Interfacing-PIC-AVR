# 1 "ECUAL/Chr_lcd/ecual_chr_lcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECUAL/Chr_lcd/ecual_chr_lcd.c" 2
# 11 "ECUAL/Chr_lcd/ecual_chr_lcd.c"
# 1 "ECUAL/Chr_lcd/ecual_chr_lcd.h" 1
# 15 "ECUAL/Chr_lcd/ecual_chr_lcd.h"
# 1 "ECUAL/Chr_lcd/../../MCAL/GPIO/hal_gpio.h" 1
# 15 "ECUAL/Chr_lcd/../../MCAL/GPIO/hal_gpio.h"
# 1 "ECUAL/Chr_lcd/../../MCAL/GPIO/../mcu_cfg.h" 1
# 15 "ECUAL/Chr_lcd/../../MCAL/GPIO/../mcu_cfg.h"
...
# 16 "ECUAL/Chr_lcd/../../MCAL/GPIO/../mcu_cfg.h" 2
...
# 19 "ECUAL/Chr_lcd/../../MCAL/GPIO/../std_libraries.h" 2
...
# 20 "ECUAL/Chr_lcd/../../MCAL/GPIO/../std_libraries.h" 2
...
# 16 "ECUAL/Chr_lcd/../../MCAL/GPIO/../compiler.h" 2
# 17 "ECUAL/Chr_lcd/../../MCAL/GPIO/../mcal_std_types.h" 2
# 105 "ECUAL/Chr_lcd/../../MCAL/GPIO/../mcal_std_types.h"
...
# 17 "ECUAL/Chr_lcd/../../MCAL/GPIO/../mcu_cfg.h" 2
# 1 "ECUAL/Chr_lcd/../../MCAL/GPIO/../device_cfg.h" 1
# 18 "ECUAL/Chr_lcd/../../MCAL/GPIO/../mcu_cfg.h" 2
# 16 "ECUAL/Chr_lcd/../../MCAL/GPIO/hal_gpio.h" 2
# 1 "ECUAL/Chr_lcd/../../MCAL/GPIO/hal_gpio_cfg.h" 1
# 17 "ECUAL/Chr_lcd/../../MCAL/GPIO/hal_gpio.h" 2
# 38 "ECUAL/Chr_lcd/../../MCAL/GPIO/hal_gpio.h"
...
# 16 "ECUAL/Chr_lcd/ecual_chr_lcd.h" 2
# 1 "ECUAL/Chr_lcd/ecual_chr_lcd_cfg.h" 1
# 17 "ECUAL/Chr_lcd/ecual_chr_lcd.h" 2
# 81 "ECUAL/Chr_lcd/ecual_chr_lcd.h"
typedef struct{
    gpio_pin_cfg rs_pin;
    gpio_pin_cfg rw_pin;
    gpio_pin_cfg en_pin;
...
# 12 "ECUAL/Chr_lcd/ecual_chr_lcd.c" 2
...
Std_ReturnType gpio_chr_lcd_4bit_init(const chr_lcd_4bit *lcd){
    ...
    if(((void*)0) == lcd){
        ...
        Retval = gpio_chr_lcd_4bit_send_command(lcd, (uint8)0x01);
        Retval = gpio_chr_lcd_4bit_send_command(lcd, (uint8)0x02);
        Retval = gpio_chr_lcd_4bit_send_command(lcd, (uint8)0x06);
        Retval = gpio_chr_lcd_4bit_send_command(lcd, (uint8)0x0C);
        Retval = gpio_chr_lcd_4bit_send_command(lcd, (uint8)0x28);
        Retval = gpio_chr_lcd_4bit_send_command(lcd, (uint8)0x80);
    }
    return Retval;
}
...
Std_ReturnType gpio_chr_lcd_4bit_send_custom_character(const chr_lcd_4bit *lcd, uint8 c_character[], uint8 row, uint8 col, uint8 ram_pos){
    ...
    if(((void*)0) == lcd){
        ...
        Retval = gpio_chr_lcd_4bit_send_command(lcd, ((uint8)0x40 + (ram_pos * 8)));
...
Std_ReturnType gpio_chr_lcd_8bit_init(const chr_lcd_8bit *lcd){
    ...
    if(((void*)0) == lcd){
        ...
        Retval = gpio_chr_lcd_8bit_send_command(lcd, (uint8)0x02);
        Retval = gpio_chr_lcd_8bit_send_command(lcd, (uint8)0x06);
        Retval = gpio_chr_lcd_8bit_send_command(lcd, (uint8)0x0C);
        Retval = gpio_chr_lcd_8bit_send_command(lcd, (uint8)0x38);
        Retval = gpio_chr_lcd_8bit_send_command(lcd, (uint8)0x80);
    }
    return Retval;
}
...
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit *lcd, uint8 row, uint8 col){
    ...
    if(((void*)0) == lcd){
        ...
        switch(row){
            case (uint8)0x01:
                Retval = gpio_chr_lcd_4bit_send_command(lcd, ((uint8)0x80 + col));
                break;
            case (uint8)0x02:
                Retval = gpio_chr_lcd_4bit_send_command(lcd, ((uint8)0xC0 + col));
                break;
            case (uint8)0x03:
                Retval = gpio_chr_lcd_4bit_send_command(lcd, ((uint8)0x94 + col));
                break;
            case (uint8)0x04:
                Retval = gpio_chr_lcd_4bit_send_command(lcd, ((uint8)0xD4 + col));
                break;
            default :
                Retval = E_NOT_OK;
                break;
...
static Std_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit *lcd, uint8 row, uint8 col){
    ...
    if(((void*)0) == lcd){
        ...
        switch(row){
            case (uint8)0x01:
                Retval = gpio_chr_lcd_8bit_send_command(lcd, ((uint8)0x80 + col));
                break;
            case (uint8)0x02:
                Retval = gpio_chr_lcd_8bit_send_command(lcd, ((uint8)0xC0 + col));
                break;
            case (uint8)0x03:
                Retval = gpio_chr_lcd_8bit_send_command(lcd, ((uint8)0x94 + col));
                break;
            case (uint8)0x04:
                Retval = gpio_chr_lcd_8bit_send_command(lcd, ((uint8)0xD4 + col));
                break;
            default :
                Retval = E_NOT_OK;
                break;
