# 1 "ECUAL/DC_Motor/ecual_dc_motor.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "ECUAL/DC_Motor/ecual_dc_motor.c" 2
# 10 "ECUAL/DC_Motor/ecual_dc_motor.c"
# 1 "ECUAL/DC_Motor/ecual_dc_motor.h" 1
# 15 "ECUAL/DC_Motor/ecual_dc_motor.h"
# 1 "ECUAL/DC_Motor/../../MCAL/GPIO/hal_gpio.h" 1
# 15 "ECUAL/DC_Motor/../../MCAL/GPIO/hal_gpio.h"
# 1 "ECUAL/DC_Motor/../../MCAL/GPIO/../mcu_cfg.h" 1
# 15 "ECUAL/DC_Motor/../../MCAL/GPIO/../mcu_cfg.h"
...
# 16 "ECUAL/DC_Motor/../../MCAL/GPIO/../mcu_cfg.h" 2
...
# 19 "ECUAL/DC_Motor/../../MCAL/GPIO/../std_libraries.h" 2
...
# 20 "ECUAL/DC_Motor/../../MCAL/GPIO/../std_libraries.h" 2
...
# 16 "ECUAL/DC_Motor/../../MCAL/GPIO/../compiler.h" 2
# 17 "ECUAL/DC_Motor/../../MCAL/GPIO/../mcal_std_types.h" 2
# 110 "ECUAL/DC_Motor/../../MCAL/GPIO/../mcal_std_types.h"
...
# 17 "ECUAL/DC_Motor/../../MCAL/GPIO/../mcu_cfg.h" 2
# 1 "ECUAL/DC_Motor/../../MCAL/GPIO/../device_cfg.h" 1
# 18 "ECUAL/DC_Motor/../../MCAL/GPIO/../mcu_cfg.h" 2
...
# 35 "ECUAL/DC_Motor/../../MCAL/GPIO/hal_gpio.h"
...
# 16 "ECUAL/DC_Motor/ecual_dc_motor.h" 2
# 1 "ECUAL/DC_Motor/ecual_dc_motor_cfg.h" 1
# 17 "ECUAL/DC_Motor/ecual_dc_motor.h" 2
# 28 "ECUAL/DC_Motor/ecual_dc_motor.h"
typedef enum{
...
# 11 "ECUAL/DC_Motor/ecual_dc_motor.c" 2
# 24 "ECUAL/DC_Motor/ecual_dc_motor.c"
Std_ReturnType gpio_dc_motor_init(const dc_motor *motor){
...
Std_ReturnType gpio_dc_motor_brake(const dc_motor *motor){
    ...
    if(((void*)0) == motor){
        ...
        gpio_logic logic[(uint8)2] = {gpio_low, gpio_low};
        for(uint8 i = 0; i < (uint8)2; i++){
...
Std_ReturnType gpio_dc_motor_rotate_clock_wise(const dc_motor *motor){
    ...
    if(((void*)0) == motor){
        ...
        gpio_logic logic[(uint8)2] = {gpio_high, gpio_low};
        for(uint8 i = 0; i < (uint8)2; i++){
            Retval = gpio_pin_write_logic(&(motor->ins[i]), logic[i]);
        }
    }
...
Std_ReturnType gpio_dc_motor_rotate_counter_clock_wise(const dc_motor *motor){
    ...
    if(((void*)0) == motor){
        ...
        gpio_logic logic[(uint8)2] = {gpio_low, gpio_high};
        for(uint8 i = 0; i < (uint8)2; i++){
            Retval = gpio_pin_write_logic(&(motor->ins[i]), logic[i]);
        }
    }
