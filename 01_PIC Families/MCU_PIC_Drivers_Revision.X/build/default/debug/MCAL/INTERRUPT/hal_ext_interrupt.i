# 1 "MCAL/INTERRUPT/hal_ext_interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL/INTERRUPT/hal_ext_interrupt.c" 2
# 10 "MCAL/INTERRUPT/hal_ext_interrupt.c"
# 1 "MCAL/INTERRUPT/hal_ext_interrupt.h" 1
# 15 "MCAL/INTERRUPT/hal_ext_interrupt.h"
...
# 16 "MCAL/INTERRUPT/hal_ext_interrupt.h" 2
# 96 "MCAL/INTERRUPT/hal_ext_interrupt.h"
        ...
        switch(inter->src){
            case interrupt_int0:
                if(interrupt_rising_edge == inter->edg){
                    (INTCON2bits.INTEDG0 = (uint8)0x01);
                }
                else if(interrupt_falling_edge == inter->edg){
                    (INTCON2bits.INTEDG0 = (uint8)0x00);
                }
                else{
                    Retval = E_NOT_OK;
                }
            ...
            case interrupt_int1:
                if(interrupt_rising_edge == inter->edg){
                    (INTCON2bits.INTEDG1 = (uint8)0x01);
                }
                else if(interrupt_falling_edge == inter->edg){
                    (INTCON2bits.INTEDG1 = (uint8)0x00);
                }
                else{
                    Retval = E_NOT_OK;
                }
            ...
            case interrupt_int2:
                if(interrupt_rising_edge == inter->edg){
                    (INTCON2bits.INTEDG2 = (uint8)0x01);
                }
                else if(interrupt_falling_edge == inter->edg){
                    (INTCON2bits.INTEDG2 = (uint8)0x00);
                }
                else{
                    Retval = E_NOT_OK;
                }
...
static Std_ReturnType external_interrupt_intx_set_disable(const interrupt_intx *inter){
    ...
    if(((void*)0) == inter){
        ...
        switch(inter->src){
            case interrupt_int0:
                (INTCONbits.INT0IE = (uint8)0x00);
                break;
            case interrupt_int1:
                (INTCON3bits.INT1IE = (uint8)0x00);
                break;
            case interrupt_int2:
                (INTCON3bits.INT2IE = (uint8)0x00);
                break;
            default :
                Retval = E_NOT_OK;
                break;
