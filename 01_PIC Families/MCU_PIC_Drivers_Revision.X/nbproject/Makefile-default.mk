...
${OBJECTDIR}/MCAL/Timers/Timer3/hal_timer3.p1: MCAL/Timers/Timer3/hal_timer3.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}/MCAL/Timers/Timer3" 
	@${RM} ${OBJECTDIR}/MCAL/Timers/Timer3/hal_timer3.p1.d 
	@${RM} ${OBJECTDIR}/MCAL/Timers/Timer3/hal_timer3.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gcoff -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/MCAL/Timers/Timer3/hal_timer3.p1 MCAL/Timers/Timer3/hal_timer3.c 
	@-${MV} ${OBJECTDIR}/MCAL/Timers/Timer3/hal_timer3.d ${OBJECTDIR}/MCAL/Timers/Timer3/hal_timer3.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/MCAL/Timers/Timer3/hal_timer3.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
